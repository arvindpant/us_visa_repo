...
RETRY_TIME = 10  # wait time between retries/checks for available dates: 10 minutes
...
def send_notification(msg):
    ...
    if SENDGRID_API_KEY:
        message = Mail(
            from_email='arvind.pant1@mail.com',
            to_emails=USERNAME,
            subject=msg,
            html_content=msg)
        try:
...
def get_driver():
    ...
    ## options is to make this code works on EC2 instance.
    options = Options()
